...
class ReleaseNotes:
    ...
    def _get_porting_guide_bytes(changelog: Changelog) -> bytes:
        ...
        builder.add_raw_rst(
            ...
            f"{changelog.acd_version.major}.{changelog.acd_version.minor}.rst)\n")
        builder.add_raw_rst(
        ...
        builder.add_raw_rst(
            ...
            ".. warning::"
            "\n\n"
            "        Links on this page may not point to the most recent versions of modules."
            ...
            " <https://github.com/ansible-collections/general/blob/master/README.rst>`_. We"
            ...
            "\n\n"
            "We suggest you read this page along with `Ansible Changelog for 2.10 <https://github"
            ".com/ansible-community/ansible-build-data/blob/main/2.10/CHANGELOG-v2.10.rst>`_"
            " to understand what updates you may need to make."
            "\n\n"
            "This document is part of a collection on porting. The :ref:`porting_2.10_guide_base`"
            " is included in this porting guide. The complete list of porting guides can be found"
            " at :ref:`porting guides <porting_guides>`."
            "\n"
        )
